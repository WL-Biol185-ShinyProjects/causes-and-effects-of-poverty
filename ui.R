...
=======
              fluidPage(
                titlePanel("Understanding Poverty"),
                   actionButton("info_button", "What Causes Poverty?", class = "btn-primary"),
                      bsModal(
                        "info_modal", 
                        ...
                        tagList(
                          ...
                          div(
                            ...
                            div(
                              class = "panel panel-default",
                              div(class = "panel-heading", h4(class = "panel-title", a("Environmental Factors", href = "#envir", "data-toggle" = "collapse"))),
...
>>>>>>> 1d240661efd6a0b93a7c399a989408de5ec0f6a4
           tabPanel("OPM vs SPM",
                    ...
                    mainPanel(
                      h3("Here's How They Compare:"),
                        p("When examining poverty levels in the United States:"),
                          ...
                          tags$li("Across racial groups, the highest overall poverty rates are found among Black and Native American populations, showing the systemic 
                                  and historical challenges these communities face.")),
